...
const listaSimplesCarros = new ListaCircularSimples<string>();
...
console.log("\nLista Dupla - Frutas");
const listaDuplaFrutas = new ListaCircularDupla<string>();
...
console.log("\nLista Simples - Notas");
const listaSimplesNotas = new ListaCircularSimples<number>();
...
const listaSimplesTarefas = new ListaCircularSimples<string>();
...
const listaDuplaPontos = new ListaCircularDupla<number>();
